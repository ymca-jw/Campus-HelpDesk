...
<main class="page">
    <section class="error-box">
        <div class="status">400 BAD_REQUEST</div>
        <h1>잘못된 요청입니다.</h1>
        <p>요청 파라미터가 누락되었거나 올바르지 않습니다. 입력 내용을 확인한 뒤 다시 시도해 주세요.</p>
        <div class="actions">
            <a class="button primary" href="${pageContext.request.contextPath}/complaints">민원 목록</a>
            <a class="button secondary" href="javascript:history.back()">이전 페이지</a>
        </div>
    </section>
</main>
</body>
